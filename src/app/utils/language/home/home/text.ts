...
export const ES_homeText : typeHomeText = {
    ...
    firstMainCardBenefits: 'COMPRA EN CUALQUIER LUGAR',
    firstSubtextCardBenefits: 'AGREGA LOS MEJORES PRODUCTOS A TU CARRITO. HACEMOS QUE LLEGUEN DONDE ESTÉS.',
    secondMainCardBenefits: 'ELIGE MÉTODO PAGO',
    secondSubtextCardBenefits: 'PAGA CON NEQUI / DAVIPLATA | BANCOLOMBIA. TU DINERO ESTÁ PROTEGIDO CON MERCADO PAGO.',
    thirdMainCardBenefits: 'TUS PRODUCTOS EN 48H',
    thirdSubtextCardBenefits: 'TUS PAQUETES ESTÁN SEGUROS. TIENES EL APOYO DE EMPRESAS DE ENVÍOS NACIONAL.',
};
